...
locale_keys! {
    ...
    ProviderClaudeAllowManagingClaudeCodeAccounts,
    ProviderClaudeAllowManagingClaudeCodeAccountsHelp,
    ...
    ClaudeAccountsTitle,
    ClaudeAccountsHint,
    ClaudeAccountsCloseWarning,
    ClaudeAccountsAddButton,
    ClaudeAccountsSwitchButton,
    ClaudeAccountsFetchButton,
    ClaudeAccountsRemoveButton,
    ClaudeAccountsEmpty,
    ClaudeAccountsSourceAmbient,
    ClaudeAccountsSourceManaged,
    ClaudeAccountsActive,
    ClaudeAccountsUsageUnavailable,
    ClaudeSwitchSuccess,
