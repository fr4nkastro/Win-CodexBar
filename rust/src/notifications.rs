...
#![allow(dead_code, reason = "notification helpers are reserved for future alert integration")]
...
fn format_duration(seconds: f64) -> String {
    ...
    #[allow(clippy::cast_possible_truncation, reason = "whole-minutes display label; ceil/max bound the value to realistic durations")]
