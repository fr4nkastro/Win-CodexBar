...
impl SessionEquivalentForecast {
    ...
    pub fn make(
        ...
        #[allow(clippy::cast_possible_truncation, reason = "window count is a small whole number; fractional part dropped by design")]
...
mod tests {
    ...
    fn forecast_make_fractional_windows() {
        ...
        #[allow(clippy::cast_possible_truncation, reason = "assertion mirrors the production whole-window truncation")]
