...
impl RateWindowCadence {
    ...
    pub fn from_seconds(seconds: i64) -> Self {
        ...
        #[allow(clippy::cast_possible_truncation, reason = "window minutes from real reset deltas fit u32")]
...
impl RateWindow {
    ...
    pub fn calendar_month_window_minutes(resets_at: DateTime<Utc>) -> Option<u32> {
        ...
        if minutes > 0 {
            ...
            #[allow(clippy::cast_possible_truncation, reason = "calendar month minutes fit u32")]
