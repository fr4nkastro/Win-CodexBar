...
fn rolling_reset(seconds: Option<f64>, now: DateTime<Utc>) -> Option<DateTime<Utc>> {
    ...
    #[expect(clippy::cast_possible_truncation, reason = "API window offset is far below i64::MAX")]
...
fn date_from_milliseconds(raw: Option<f64>) -> Option<DateTime<Utc>> {
    ...
    #[expect(clippy::cast_possible_truncation, reason = "fractional second keeps nanoseconds < u32::MAX")]
