...
struct CostBucket {
    start_time: i64,
    #[allow(dead_code, reason = "field present in the OpenAI API billing payload; kept so serde preserves it")]
    end_time: i64,
...
#[allow(dead_code, reason = "OpenAI API helper reserved for future dashboard integration")]
