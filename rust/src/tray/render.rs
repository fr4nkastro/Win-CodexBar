...
pub fn render_bar_icon_rgba(
    ...
    let color_for = |percent: f64| -> (u8, u8, u8) {
        ...
        if has_error {
            ...
            #[allow(clippy::cast_possible_truncation, reason = "mean of three u8 channels; r+g+b ≤ 765, divided by 3 is ≤ 255 and fits u8")]
    ...
    #[allow(clippy::cast_possible_truncation, reason = "pct clamped to 0–100 and scaled by bar_width ≤ 32; result is a small pixel count that fits u32")]
...
pub fn render_percent_icon_rgba(percent: f64, has_error: bool) -> (Vec<u8>, u32, u32) {
    ...
    #[allow(clippy::cast_possible_truncation, reason = "percent is clamped to 0–100 and rounded; the integer fits u32")]
    ...
    #[allow(clippy::cast_possible_truncation, reason = "text is \"100\" or \"NN%\", so len ≤ 4 and fits u32")]
        ...
        for col in 0..3 {
            ...
            for yy in 0..scale {
                for xx in 0..scale {
                    ...
                    #[allow(clippy::cast_possible_truncation, reason = "row_idx iterates over a fixed [u8; 5] glyph, so it is 0..5 and fits u32")]
