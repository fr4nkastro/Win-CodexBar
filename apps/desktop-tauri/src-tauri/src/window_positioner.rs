...
#![allow(dead_code, reason = "window positioner types reserved for future window management integration")]
...
fn clamp_to_work_area(
    ...
    #[expect(clippy::cast_possible_wrap, reason = "monitor pixel dimensions fit in i32")]
...
fn calculate_anchored_position(
    ...
    #[expect(clippy::cast_possible_wrap, reason = "tray icon pixel dimensions fit in i32")]
